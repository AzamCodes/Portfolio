...
const Footer = () => {
  return (
    <div className="px-4 pb-4 md:pb-8  bg-black/95 md:px-8">
      <div className="relative px-2 md:px-8 rounded-2xl  py-6 border-transparent  bg-black/85 border backdrop-filter backdrop-blur-lg bg-opacity-10  shadow-lg md:py-12  overflow-hidden font-agrandir-regular">
        {/* Torchlight Effect */}
